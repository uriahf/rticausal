...
The initial scope is static binary discrete calibration. `create_summary_report()` contains calibration only. Existing `rtichoke` rendering machinery is reused after the calibration coordinates are prepared.
